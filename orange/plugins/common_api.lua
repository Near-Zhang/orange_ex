        ...
        POST = function(store) 
            return function(req, res)
                ...
                if not selector then
                    return res:json({
                            success = false,
                            msg = "selector is not a standard json"
                        })
                end
        ...
        POST = function(store)
            return function(req, res, next)
                ...
                if not rule then
                    return res:json({
                            success = false,
                            msg = "rule is not a standard json"
                        })
                end
        ...
        PUT = function(store) 
            return function(req, res, next)
                ...
                if update_result then
                    ...
                    if not success or err or forcible then
                    ...
                    return res:json({
                        success = true,
                        msg = "success to update the rule"
                    })
                end
